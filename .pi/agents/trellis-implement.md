...
2. **Run** `C:/Users/Administrator/AppData/Local/Programs/Python/Python314/python.exe ./.trellis/scripts/task.py current --source` and read the `Current task:` line.
